# Based on: https://github.com/Anoncheg1/stable-ts-con
...
from stable_whisper.stabilization import stabilize_timestamps
...
def transcribe_word_level(
        ...
        *,
        ...
        prepend_punctuations: Union[List[str], Tuple[str]] = None,
        append_punctuations: Union[List[str], Tuple[str]] = None,
        audio_for_mask: Union[str, bytes] = None,
        **decode_options):
    """
    ...
    def _to_list(x: Union[Tensor, None]):
        if x is None:
            return x
        return x.tolist()
